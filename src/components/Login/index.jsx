    ...
    <div className="container flex h-screen rounded-lg bg-[#050A44]">
      ...
      <div className="bg-white w-3/5 flex flex-col rounded-lg justify-center items-center">
        <div className="container w-4/5 px-10 flex flex-col">
          ...
          <form className="container  placeholder:text-sm" onSubmit={handleLogin} ref={form}>
            ...
            <div className="container flex flex-col mt-2">
              ...
              />
              <div>
                <button disabled={loading} className="container flex justify-center items-center p-1 py-2 my-3 w-full border rounded-lg bg-[#EB268F] text-white font-semibold">
                  <div>Login</div>{loading && <ImSpinner2 className="animate-spin" aria-label="loading"/>}
                </button>
              </div>
            </div>
          </form>
          <div className="text-sm">
            Don't have an account? <Link className="text-blue-900" to={"/customer/signup"}>Register</Link>
          </div>
