  ...
  const handleImageUpload = async (e) => {
    ...
    reader.onload = (event) => {
      ...
      imgObj.onload = function () {
          const img = new fabric.FabricImage(imgObj);
          ...
          if (canvasSide === "front") {
              ...
              img.scaleToHeight(canvasBack.height);
              img.scaleToWidth(canvasBack.width);
  ...
  return (
    <>
      ...
      please
            ...
            <div className="mb-1">
              please ensure you are adhering the T&C of{" "}
              <span className="text-pink-600">vibepulse Upload Policy.</span>
            </div>
          </div>
          <div className="flex items-center justify-center gap-4">
            <label
              style={{ filter: "drop-shadow(4px 4px 1px black)" }}
              className="cursor-pointer w-full bg-pink-600 text-center py-1 rounded-md"
              htmlFor="fileUpload"
            >
              Proceed
              <input
